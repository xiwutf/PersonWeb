<template>
  ...
  <Transition name="slide-up">
    <div
      v-if="isOpen"
      class="fixed bottom-2 right-2 w-96 h-[600px] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 flex flex-col overflow-hidden"
    >
      <!-- 头部 -->
