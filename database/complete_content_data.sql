...
('home_hero_intro', '专注于将技术转化为可持续积累的数字资产。', '首页个人简介'),
('home_platform_desc', 'AI 系统 · 工业软件 · 个人数字系统 · 可复用模块', '平台定位描述'),

-- 关于我页面内容
('about_intro', '系统型工程师 + AI 实践者，专注于 AI 系统落地、工业软件与个人数字系统。', '关于我一句话介绍'),
('about_detail', '我不只是写代码，而是致力于将技术转化为可持续积累的数字资产。更关注系统是否可复用、能否形成长期积累、是否具备产品化与商业化潜力。正在构建 AI + 软件工程 + 自动化系统的完整体系，实现技术积累、产品沉淀与收入复利。', '关于我详细介绍'),
('about_skills', '前端：Vue3、Nuxt3、TypeScript、Naive UI | 后端：.NET WebAPI、Python FastAPI | 数据：MySQL、SQL Server | AI：RAG、Agent、LLM 集成 | 长期使用：ChatGPT、Claude、Cursor', '技能栈'),
('about_goals', 'AI Agent 平台化 | 模块化软件系统（可售卖） | 自动化工作流系统 | AI + 工业场景融合 | 打造可持续增长的数字资产系统', '目标'),
