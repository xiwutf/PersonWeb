    ...
    <div class="blog-shell">
      <section class="blog-hero">
        <div class="blog-hero-copy">
          ...
          <p class="blog-subtitle">
            技术实践、项目复盘与可检索的公开文章。系统化短笔记在「知识笔记」；个人方法论见 Life「说明书」。
          </p>
      ...
      <section class="blog-layout">
                ...
                <div class="blog-post-card-inner">
                  ...
                  <div class="blog-post-content">
                    <div class="blog-post-meta">
                      <NuxtLink
                        :to="`/work/blog?category=${encodeURIComponent(post.category)}`"
                    ...
                    <div class="blog-post-footer">
                      <div class="blog-post-tags">
                        <NuxtLink
                          ...
                          :key="tag"
                          :to="`/work/blog?search=${encodeURIComponent(tag)}`"
                          class="blog-post-tag"
                          @click.stop
                        >
                          #{{ tag }}
        ...
        <aside class="blog-sidebar">
          <div class="blog-sidebar-card">
            ...
            <div class="blog-tags">
              <NuxtLink
                ...
                :key="tagInfo.tag"
                :to="`/work/blog?search=${encodeURIComponent(tagInfo.tag)}`"
                class="blog-tag-item"
              >
          ...
          <div class="blog-back-card" @click="navigateTo('/work/lab')">
...
const { data: allPosts, pending: blogLoading } = useLazyAsyncData('blog-posts', async () => {
  ...
  return list.map((article: any) => {
    ...
    return {
      ...
      id: articleId,
      slug: articleSlug,
      _path: pathSegment ? `/work/blog/${pathSegment}` : '#',
...
const getArticlePath = (post: any) => {
  ...
  return pathSegment ? `/work/blog/${pathSegment}` : '/work/blog'
}
