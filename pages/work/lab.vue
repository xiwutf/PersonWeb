        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <AppCard class="p-6 backdrop-blur-xl">
            <h3 class="mb-3 flex items-center justify-between text-base font-semibold text-text-main">
              <span>📚 博客星球</span>
              <NuxtLink to="/work/blog" class="text-xs text-primary transition-colors hover:text-primary-hover">
                进入博客
              </NuxtLink>
            </h3>
          ...
          <AppCard class="p-6 backdrop-blur-xl">
            <h3 class="mb-3 flex items-center justify-between text-base font-semibold text-text-main">
              <span>🚀 项目飞船</span>
              <NuxtLink to="/work/projects" class="text-xs text-primary transition-colors hover:text-primary-hover">
                查看项目
              </NuxtLink>
            </h3>
            <p class="mb-4 text-xs leading-relaxed text-text-muted">
