<template>
  <div class="side-project-detail-page">
    ...
    <div class="back-button-container">
      <NuxtLink to="/work/side-projects" class="back-button">
    ...
    <div v-else-if="error" class="error-container">
      ...
      <NuxtLink to="/work/side-projects" class="error-button">
        返回项目列表
      </NuxtLink>
    </div>
...
const fetchProject = async () => {
  ...
  try {
    const res = await api.get<any>(`/work/side-projects/public/${id}`)
