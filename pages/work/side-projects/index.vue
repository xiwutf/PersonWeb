...
const fetchStats = async () => {
  try {
    const res = await api.get<any>('/work/side-projects/public/dashboard/summary')
...
const fetchProjects = async () => {
  ...
  try {
    const res = await api.get<any>('/work/side-projects/public', {
...
const handleProjectClick = (id: number) => {
  router.push(`/work/side-projects/${id}`)
}
