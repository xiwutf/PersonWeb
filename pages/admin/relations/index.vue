...
const allPersons = ref<RelationPerson[]>([]) // 存储所有数据
...
const extractStatusHint = (response: any, person: RelationPerson): string => {
  ...
  if (daysSinceContact >= 30) {
    return `已 ${daysSinceContact} 天未联系`
