      ...
      <div class="about-content">
        ...
        <div class="about-contact-section">
          <div class="about-contact-content">
            <h2 class="about-contact-title">????</h2>
            ...
            <div class="about-contact-qr">
              <div class="about-contact-qr-image">
                <img src="/images/wechat-qr.png" alt="?????" />
              </div>
              <p class="about-contact-qr-text">??????</p>
            </div>
          </div>
        </div>
...
const skillCategories = [
  ...
  },
  {
    ...
    icon: '??',
    color: 'emerald',
    skills: ['C/C++', 'STM32', 'Arduino', 'ESP32', '?????', '????']
  }
]
...
const achievements = [
  {
    ...
    type: 'AI ??',
    year: '2024',
    desc: '?? LangChain ??????? Agent??? RAG???????????'
  },
  {
    title: '??????',
    type: '????',
    year: '2024',
    desc: '???????5000+ ???800+ ???98% Lighthouse ?????'
  },
  {
    title: 'Revit BIM ????',
    type: '????',
...
const experience = [
  {
    title: '????',
    duration: '3?+',
    desc: '?? Web ?????? Vue/React ? Node.js ??????????????'
  },
  {
    title: 'Revit ????',
    duration: '2?+',
    desc: 'BIM ?? Revit API ?????C#/.NET ?????????????'
  },
  {
    title: 'AI ????',
    duration: '1?+',
    desc: '?? AI ?????? LLM ??? Agent ??????? AI ?????'
  }
]
