  ...
  ;(async () => {
    ...
    try {
      ...
      if (configs) {
        ...
        if (configs.font_family) fontSettings.fontFamily = configs.font_family
        if (configs.base_font_size) fontSettings.baseFontSize = parseInt(configs.base_font_size) || 16
        if (configs.default_font_weight) fontSettings.defaultFontWeight = configs.default_font_weight
        if (configs.default_line_height) fontSettings.defaultLineHeight = parseFloat(configs.default_line_height) || 1.6
        if (configs.h1_font_size) fontSettings.h1FontSize = parseInt(configs.h1_font_size) || 32
        if (configs.h2_font_size) fontSettings.h2FontSize = parseInt(configs.h2_font_size) || 24
        if (configs.h3_font_size) fontSettings.h3FontSize = parseInt(configs.h3_font_size) || 20
        if (configs.h4_font_size) fontSettings.h4FontSize = parseInt(configs.h4_font_size) || 18
        if (configs.text_main_color) fontSettings.textMainColor = configs.text_main_color
        if (configs.text_muted_color) fontSettings.textMutedColor = configs.text_muted_color
